...
class SettingsManager(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_EXCLUDE_MARKED      = "exclude_marked"
    }
    ...
    var excludeMarkedEnabled: Boolean
        get() = prefs.getBoolean(KEY_EXCLUDE_MARKED, false)
        set(value) { prefs.edit().putBoolean(KEY_EXCLUDE_MARKED, value).apply() }
