...
- **🔍 Duplicate Finder**: A new icon in the Gallery top bar scans your device for exact-duplicate photos and videos (by content hash, not just filename), groups them, auto-suggests keeping the newest copy of each, and lets you delete the rest to free up storage — using the standard system delete-confirmation flow.
- **📊 14-Day Activity Chart**: The History screen now shows a small bar chart of your backup activity over the last 14 days.
