...
## ⚖️ License & Privacy
This project is licensed under the [MIT License](LICENSE) — see the file for details. This app is provided "as-is" for personal backup purposes. We do not collect any data. All credentials and media paths stay on your device or in your private Telegram group — and as of v3.0.0, the cloud backup file itself carries no secrets either.
